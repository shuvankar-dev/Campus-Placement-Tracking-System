...
<body class="bg-light">
    ...
    <div class="d-flex" id="wrapper">
     ...
     <!-- Sidebar -->
    <div class="p-3" style="width: 250px; min-height: 100vh; background: linear-gradient(135deg, #198754 0%, #20c997 100%);">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="#" class="nav-link text-white active fw-bold">Approved Applications</a></li>
